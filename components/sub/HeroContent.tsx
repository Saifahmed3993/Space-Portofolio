                    ...
                    <div className="h-full w-full md:w-3/6 flex flex-col gap-5 justify-center text-start">
                        ...
                        <InView triggerOnce={false}>
                            {({ inView, ref }) => (
                                ...
                                >
                                    <li>
                                        .NET Team Leader at Digital Egypt Pioneers
                                    </li>
                                    <li>
                                        Frontend Developer Intern at Elevo Pathway
                                    </li>
                                    <li>
                                        Database Designer Intern at Mylerz.co
                                    </li>
                                    <li>
                                        BSc in Information Systems, MUST (Expected 2027)
                                    </li>
                                </motion.div>
                            )}
                        </InView>
